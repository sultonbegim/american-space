    ...
    <div class="relative pt-6  pb-6">
      <nav class="relative flex items-center justify-between sm:h-10 md:justify-center" aria-label="Global">
        <div class="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
          <div class="flex items-center justify-between w-full md:w-auto">
            <a href="#"><span class="sr-only">Company Name</span>
              <img class="w-auto h-[70px]" src="/images/as.jpg" loading="lazy">
            </a>
        ...
        <div class="hidden md:flex md:space-x-10 list-none">
          <li>
            <NuxtLink to="/" class="text-base font-normal text-gray-500 list-none hover:text-gray-900"
               target="">Khorog American Space </NuxtLink>
          </li>
          <li>
            <NuxtLink to="/education-culture" class="text-base font-normal text-gray-500 list-none hover:text-gray-900"
               target="">Education & Culture
            </NuxtLink>
          </li>
          <li>
            <NuxtLink to="/new-advents" class="text-base font-normal text-gray-500 list-none hover:text-gray-900"
               target="_blank"> News & Advents
            </NuxtLink>
          </li>
        </div>

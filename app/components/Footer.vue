...
<template>
  <footer>
    ...
    <div class="bg-gray-800 py-4 text-white ">
      <hr/>
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 my-4 w-full xl:w-1/5">
            <a href="/" class="block w-56 mb-10">
              <img src="/images/as2.jpg" class="rounded-lg mt-14" alt="asc">
            </a>
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            ...
            <ul class="leading-8">
              <li><NuxtLink to="/khorog-as" class="hover:text-blue-400">Khorog American Space</NuxtLink></li>
              <li><NuxtLink to="/education-culture" class="hover:text-blue-400">Education &amp; Culture</NuxtLink></li>
              <li><NuxtLink to="/new-advents" class="hover:text-blue-400">News &amp Advents</NuxtLink></li>
